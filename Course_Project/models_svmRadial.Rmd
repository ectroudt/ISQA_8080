...
num_cores <- detectCores(8) #note: you can specify a smaller number if you want
...
model_form <- churned ~ Business_Code + Major_Industry_Category_Name + Population_Code + total_transactions + Manufacturing_Indicator + Number_of_Family_Members + Legal_Status_Code + total_revenue
