...
rf_heart_random <- train(as.formula(model_form), data = data_train, method = model_type, trControl = trControl, metric = 'ROC', tuneLength = 20)
...
rf_heart_grid <- train(model_form, data = data_train, method = model_type, trControl = trControl, metric = 'ROC', tuneGrid = tGrid)
...
xgb_heart <- train(as.formula(model_form), data = data_train, method = model_type, trControl = trControl, metric = 'ROC')
...
xgb_heart <- train(as.formula(model_form), data = data_train, method = model_type, trControl = trControl, metric = 'ROC', tuneGrid = tGrid, verbose = FALSE)

# alternative: random search
trControl <- trainControl(method = 'cv', savePredictions = TRUE, classProbs = TRUE, summaryFunction = twoClassSummary, search = 'random')
xgb_heart_randomSearch <- train(as.formula(model_form), data = data_train, method = model_type, trControl = trControl, metric = 'ROC', tuneLength = 50, verbose = FALSE)
...
rf_heart <- train(as.formula(model_form), data = data_train, method = 'rf', trControl = trControl, metric = 'ROC')
