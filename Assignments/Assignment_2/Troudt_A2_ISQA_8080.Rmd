...
# Inspect dataset, are all variables correctly set as factors?
names(census_Data)
head(census_Data)
dim(census_Data)
...
**b**. After generating the 70-30 split and producing summaries of each data set, the distributions of the variables within each data-set appear to be very similar, without any noticeable significant differences.
